...
// - 제공된 hmac이 URL-encoded 상태인 경우 자동으로 디코딩해서 비교합니다.
// - DEBUG_HMAC=true인 경우 /debug/hmac에서 입력 쿼리를 넣어 어떤 메시지로 해시를 만들었는지와 계산된 digest들을 확인할 수 있습니다.
// ──────────────────────────────────────────────────────────────────
...
// 콜백 핸들러: code → 토큰 발급 → DB에 mallId별 저장 → onimon.shop 으로 리다이렉트 연결
